    ...
    '& .react-datepicker': {
      ...
      '& > .react-datepicker__navigation': {
        ...
        '&.react-datepicker__navigation--previous': {
          ...
          height: 24,
          border: 'none',
          ...(theme.direction === 'rtl' ? { left: 15 } : { right: 15 }),
        ...
        '&.react-datepicker__navigation--next': {
          ...
          height: 24,
          border: 'none',
          ...(theme.direction === 'rtl' ? { right: 15 } : { left: 15 }),
        ...
        '&.react-datepicker__navigation--next--with-time': theme.direction === 'rtl' ? { right: 127 } : { left: 127 },
        '&:focus, &:active': {
          outline: 0
        }
      },
