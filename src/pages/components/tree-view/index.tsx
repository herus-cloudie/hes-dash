    ...
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          ...
          <TreeViewMultiSelection direction={'rtl'} />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        <CardSnippet
        ...
        >
          ...
          <TreeViewControlled direction={'rtl'} />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        <CardSnippet
        ...
        >
          ...
          <TreeViewRichObject direction={'rtl'} />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        <CardSnippet
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <TreeViewGmailClone direction={'rtl'} />
        </CardSnippet>
      </Grid>
    </Grid>
  )
