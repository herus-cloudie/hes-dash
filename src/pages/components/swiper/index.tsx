    ...
    <KeenSliderWrapper>
      <Grid container spacing={6} className='match-height'>
        ...
        <Grid item xs={12}>
          ...
          >
            <SwiperMultipleSlides direction={'rtl'} />
          </CardSnippet>
        </Grid>
        <Grid item xs={12}>
          <CardSnippet
        ...
        <Grid item xs={12}>
          ...
          >
            <SwiperThumbnails direction={'rtl'} />
          </CardSnippet>
        </Grid>
        <Grid item xs={12}>
          <CardSnippet
        ...
        <Grid item xs={12}>
          ...
          >
            <SwiperMutationObserver direction={'rtl'} />
          </CardSnippet>
        </Grid>
      </Grid>
    </KeenSliderWrapper>
